...
if ($_SESSION['nama_pelanggan'] !== null) {
    ...
    $querypesanan = "SELECT * FROM pesanan JOIN pelanggan ON pesanan.id_pelanggan = pelanggan.id_pelanggan WHERE pesanan.status_pesanan = 'selesai' AND pesanan.id_pelanggan = $id";
